...
<br/>
클라이언트 메시지 카운터는 각각 3개씩의 프로듀서/컨슈머로 메시지를 컨슈밍하고, 캐시 서버에 업데이트하고, 다시 오프셋 커밋과 메시지 프로듀싱을 트랜잭션으로 묶어서 처리하다보니 초당 약 600개씩의 메시지를 프로듀싱함
...
#### 컨슈머/프로듀서 개수를 5개씩, 2개의 컨슈머 서버로 실행
