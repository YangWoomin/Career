...
JOYCITY(2년) : 프리스타일 풋볼 서버 개발 및 한국/중국/스팀 서비스 운영

NCSOFT(5년~) : LLL 서버 개발 및 인프라, CI/CD 운영

## 포트폴리오 간단 요약

학부생 포트폴리오 : 커리큘럼 과목 중 학기 프로젝트 또는 졸업 작품을 모아서 포트폴리오 작성

NCSOFT 포트폴리오 : ZilliaxServer, 경력이 인프라 쪽 위주로 좀 치중된 것 같아서 C/C++ 크로스 플랫폼 데이터베이스/네트워크 프로그래밍으로 포트폴리오 작성
