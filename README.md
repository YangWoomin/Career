...
나를 표현하기에 이보다 더 좋은 문구는 없을 것 같은데 5년 뒤, 10년 뒤, 20년 뒤에도 저 문구가 계속 유효할까? 라는 고민이요.

사실 이렇게 자신의 총 경력이나 포트폴리오를 소개하는 메인 페이지에 적는 인사말은 바꾸지 않고 계속 초심 유지하듯 놔두면 좋잖아요.

이렇게 짧은 고민을 했지만.. 제 자신을 너무 잘 알기 때문에 바뀌지 않을 것이라는 확신이 들더군요.

이유는 제가 근본적으로 욕심이 많아서 입니다.

공동체에서 없어서는 안 될 구성원으로서 살아가는 것이 제 인생의 가장 큰 낙인데,

없어서는 안 될 구성원이 되려면 계속 내 자신을 채찍질하며 성장시켜야 하고 이는 본능적으로 내 자신을 채우려는 욕심으로 나타나는 것 같습니다.
...
학부생 포트폴리오 : 커리큘럼 과목 중 학기 프로젝트 또는 졸업 작품을 모아서 포트폴리오 작성

NCSOFT 포트폴리오 : ZilliaxServer, C/C++ 크로스 플랫폼 데이터베이스/네트워크 프로그래밍으로 포트폴리오 작성
